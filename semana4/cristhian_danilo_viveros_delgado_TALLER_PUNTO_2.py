...
escribir_linea_archivo(nombre_archivo_liquidacion,"  Nombre completo  |  Salario base  | Auxilio Trasporte | Cesantias | Intereses sobre cesantias | Prima | Vacaciones | ARL | Salud Empresa | Pension empresa | Salud empleado | Pension empleado | Fondo de solidaridad | Costo total empresa | Salario neto \n") 
