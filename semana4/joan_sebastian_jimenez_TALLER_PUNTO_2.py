...
contenido_linea = ("nombre*salario|auxilio transporte efectivo|cesantias*intereses sobre cesantias*prima*vacaciones|arl*salud empresa*pension |salud empleado*pension empleado*fondo solidaridad|costo empresa|salario neto empleado\n")
