...
escribir_linea_archivo(nombre_archivo_liquidacion, ("[NOMBRE COMPLETO*SALARIO BASE|AUXILIO TRANSPORTE EFECTIVO|CESANTIAS*INTERESES CESANTIAS*PRIMA*VACACACIONES|ARL*SALUD EMPRESA*PENSION EMPRESA|SALUD EMPLEADO*PENSION EMPLEADO*FONDO SOLIDARIDAD|COSTO TOTAL EMPLEADO|SALARIO NETO EMPLEADO\n"))
