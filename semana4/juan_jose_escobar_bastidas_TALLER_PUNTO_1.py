...
# Desarrollado por Carlos Manuel Montoya Gonzalez y editado por Juan José Escobar
# Agosto 31 de 2015
...
for z in range(0, numero_lineas_nombres):
	...
	# Costo total para la empresa+	guardar_log("Calculando costo total para la empresa ...");
