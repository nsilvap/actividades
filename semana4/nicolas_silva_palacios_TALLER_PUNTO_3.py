...
# Desarrollado por Jacobo Posada Hoyosa
...
# Funcion que imprime el array de liquidacion de la nomina.
def imprimir_array_liquidacion (liquidacion):
	print "---------------------ARRAY LIQUIDACION------------------\n"
	for x in liquidacion:
		print(x)


# Funcion que imprime el archivo de liquidacion de la nomina.
def imprimir_archivo_liquidacion (nombre_archivo_liquidacion):
	print "---------------------ARCHIVO LIQUIDACION-----------------\n"
	liq= open(nombre_archivo_liquidacion, 'r') 
	print liq.read()
...
imprimir_array_liquidacion(liquidacion)
imprimir_archivo_liquidacion(nombre_archivo_liquidacion)
