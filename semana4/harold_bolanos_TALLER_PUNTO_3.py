...
#Funciones para imprimir la liquidacion

def imprimir_array_liquidacion(array_liquidacion):
	print array_liquidacion

imprimir_array_liquidacion(liquidacion)

def imprimir_archivo_liquidacion(archivo_liquidacion):
	print(leer_lineas_archivo(archivo_liquidacion))
