...
#Referencia tomada de Juan Sebastian Lopez Villa
...
# funcion  imprimir_array_liquidacion 
def imprimir_a_liquidacion(imprimir_array_liquidacion):
	imprimir_array_liquidacion = liquidacion
	guardar_error(mensaje_terminacion)
	guardar_log("Programa terminado por error... Verificar archivo errores.txt para mas detalles.")
	
# funcion imprimir_archivo_liquidacion
def imprimir_ar_liquidacion(imprimir_archivo_liquidacion):
	imprimir_archivo_liquidacion = nombre_archivo
	guardar_error(mensaje_terminacion)
	guardar_log("Programa terminado por error... Verificar archivo errores.txt para mas detalles.")
...
for w in range(0, numero_lineas_nomina):
	contenido_linea = (
		...
		liquidacion[w][11],
		liquidacion[w][12]
	liquidacion[w'liquidacion neta para el empleado'][12]	
