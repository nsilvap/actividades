...
def leer_numerico_entero( mensaje_a_mostrar ):
	...
	while (True):	
		try:
			numero_entero = int(raw_input(mensaje_a_mostrar))
			break
		except ValueError:
			print "El valor ingresado no es numerico, por favor ingrese nuevamente: \n"
   
	return numero_entero

#obtiene v el numero de argumentos 
...
#Porcentaje de riesgos profesionales
porcentaje_riesgos = 0.0212529
