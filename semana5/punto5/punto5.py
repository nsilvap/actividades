...
contenido_linea = ("total nomina",(total_ingenieros+total_tecnicos+total_operarios+total_secretarios),"Ingenier@s", total_ingenieros, "Tecnic@s", total_tecnicos, "Operari@s", total_operarios, "Secretari@s", total_secretarios)
