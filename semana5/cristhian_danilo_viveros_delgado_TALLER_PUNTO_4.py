...
# en el archivo liquidacion.txt el cual tambien contiene el total de nominas y el total por cada cargo, el registro de errores en errores.txt 
# y el registro de operacion en log.txt.
...
escribir_linea_archivo(nombre_archivo_liquidacion, "Total Nomina Mensual: " + "%.2f" % total_nomina_mensual + " |Total Nomina Ingenieros: " + "%.2f" % total_nomina_ingenieros + " |Total Nomina Tecnicos: " + "%.2f" % total_nomina_tecnicos + " |Total Nomina Secretarios: " + "%.2f" % total_nomina_secretarios + " |Total Nomina Operarios: " + "%.2f" % total_nomina_operarios + "\n")
