...
# Modifcar porcentaje segun el tipo de riesgo definido en: https://www.positiva.gov.co/ARL/Paginas/default.aspx+porcentaje_riesgos = 0.00522
...
for z in range(0, numero_lineas_nomina):
	...
	if nomina[z][2].startswith("ingenier@"):
		...
		total_secretarias = total_secretarias + costo_total_empresa
		...
		total_productores = total_productores + costo_total_empresa
...
contenido_linea = ("total nomina",(total_ingenieros+total_tecnicos+total_productores+total_secretarias),"Ingenier@", total_ingenieros, "Tecnic@", total_tecnicos, "Operari@", total_productores, "Secretari@", total_secretarias)
formato_linea = "%s: %.2f    |%s: %.2f|     %s: %.2f|     %s: %.2f|     %s: %.2f|\n\n"
escribir_linea_archivo(nombre_archivo_liquidacion, formato_linea % (contenido_linea))
contenido_linea = ("Salario promedio para todos los empleados", (float(suma_nomina)/float(numero_lineas_nomina)), "Salario promedio ingenieros", (float(total_ingenieros)/float(contador_ing)), "Salario promedio para tecnicos", (float(total_tecnicos)/float(contador_tec)), "Salario promedio productores", (float(total_productores)/float(contador_ope)), "Salario promedio secretarias", (float(total_tecnicos)/float(contador_tec)))
formato_linea = "%s: %.2f | %s: %.2f | %s: %.2f | %s: %.2f | %s: %.2f|\n\n"
escribir_linea_archivo(nombre_archivo_liquidacion, formato_linea % (contenido_linea))
contenido_linea = ("Total nomina todo el anio", (suma_nomina*12), "Nomina anual para ingenieros", (total_ingenieros*12), "Nomina anual para tecnicos", (total_tecnicos*12), "Nomina anual para productores", (total_productores*12), "Nomina anual para secretarias", (total_secretarias*12))
formato_linea = "%s: %.2f | %s: %.2f | %s: %.2f | %s: %.2f | %s: %.2f|\n\n"
escribir_linea_archivo(nombre_archivo_liquidacion, formato_linea % (contenido_linea))
