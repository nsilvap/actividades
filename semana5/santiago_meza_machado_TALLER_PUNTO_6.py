# AyudanteNomina v2.5
'''
Programa para calcular la nomina de una empresa. Lee los nombres, salarios desde un archivo
de texto que se suministra como argumento de linea de comandos, a la vez lee desde dos archivos de texto
las apropiaciones y deducciones que se suministran como argumentos de linea de comandos. Al final guarda
la liquidacion en el archivo liquidacion.txt, el registro de errores en errores.txt y el registro de 
operacion en log.txt.
'''
