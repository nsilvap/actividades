...
for z in range(0, numero_lineas_nomina):
	...
	# Se suman las nominas por tipo de empleado y total de nomina
	if cargo_empleado == "Ingeniero" or cargo_empleado == "Ingeniera":
		acumulador_ingenieros = acumulador_ingenieros + salario_base 
	
	if cargo_empleado == "Mensajero":
		acumulador_mensajeros = acumulador_mensajeros + salario_base
	
	if cargo_empleado == "Tecnico" :
		acumulador_tecnicos = acumulador_tecnicos + salario_base 
	
	if cargo_empleado == "Secretaria":
		acumulador_secretarias = acumulador_secretarias + salario_base
	
	if cargo_empleado == "Operario" or cargo_empleado == "Operaria":
		acumulador_operarios = acumulador_operarios + salario_base
